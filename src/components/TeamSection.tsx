        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-2xl">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-2 leading-tight">Harshit Gautam</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-2xl">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-2 leading-tight">Hardik Mittal</h3>
              <p className="text-gray-600 text-base md:text-lg leading-relaxed">AI/ML & Frontend Developer</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg flex flex-col items-center transition-transform transform hover:scale-105 hover:shadow-2xl">
              <Image src="/avatar2.svg" alt="Team Member 3" width={96} height={96} className="w-24 h-24 rounded-full mb-4" />
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-2 leading-tight">Naisha Gulati</h3>
